...
# Response to Buchel et al. 

We received feedback on our analysis approach from Buchel et al. https://github.com/olegolt/PAF_reanalysis/tree/main . Here is our response to this feedback below. 
...
## An alternative approach addressing the author’s concern of a single test split yields an AUC of 0.88.

Based on the points above, we contend that our pre-defined analysis approach was the most appropriate statistical analyses for analytical validation of our biomarker. However, to directly address the concerns raised by the authors of using a single test split, we ran a more generalizable statistical approach using an ensemble of 50 logistic regression models, selected as the top 10% of 500 models based on validation performance. 
